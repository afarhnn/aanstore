...
1. Copy file .env.example ke backend/.env dan lengkapi jika perlu.
2. Jalankan: docker compose up --build
3. Backend akan tersedia di http://localhost:4000
4. Flutter: buka frontend/ di VS Code atau Android Studio, jalankan `flutter run -d chrome` atau device Anda.
